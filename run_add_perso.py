...
sys.path.append('./')
from add_data_perso import add_data_p
from model import *
from utils import *
...
##Model Constants
d_model = 24 # dimension de l'embedding.
num_layers = 6
dff = 128 ## Dim de la couche du feed forward

target_vocab_size = BINARY_SIZE + 1 ## taille de la sortie
dropout_rate = 0.1
res_ratio = 1.5
...
#Creation Dataset
t_ds,v_ds=add_data_p(T_SIZE,V_SIZE,BINARY_SIZE)
...
transformer_1 = Transformer(num_layers, d_model, BINARY_SIZE+1, dff, pos, target_vocab_size, make_sym, USE_positioning_1,
